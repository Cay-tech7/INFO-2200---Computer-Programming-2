...
namespace Project3_CaydenEastman.Images
{
    ...
    {
        public Coyote(string foodTypeParameter, string skinTypeParameter) : base(foodTypeParameter, skinTypeParameter)
        {
        }

        public override string Pet()
        {
            return "That's not a dog, and its gonna bite";
        }

        public override string Sound()
        {
            return "Yip yip...YiiiiIIIAAAHHHH!";
        }
    }
}
