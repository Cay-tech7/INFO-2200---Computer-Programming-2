    ...
    public class SynchronousSocketClient
    {
        ...
        public string ContactServer(string clientRequest)
        {
            ...
            try
            {
                ...
                //ATTEMPT TO ESTABLISH A CONNECTION TO OUR SERVER USING TEH PROVIDED PORT AND IP ADDRESS
                client.Connect(IPAddress.Parse(SERVER_ADDRESS), SERVER_PORT);

                //access the network stream of data between teh server and the client
